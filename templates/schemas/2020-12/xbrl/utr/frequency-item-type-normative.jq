{
  ...
  "title": ("XBRL UTR frequency Item Type units (" + .["{http://www.xbrl.org/2009/utr}utr"]["@attributes"].lastUpdated + ")"),
  "description": "Valid units for frequencyItemType as defined in the XBRL Units Type Registry",
  "examples": (
    .["{http://www.xbrl.org/2009/utr}utr"]["{http://www.xbrl.org/2009/utr}units"]["{http://www.xbrl.org/2009/utr}unit"]
    | map(select(.["{http://www.xbrl.org/2009/utr}itemType"] == "frequencyItemType" and .["{http://www.xbrl.org/2009/utr}status"] == "REC"))
