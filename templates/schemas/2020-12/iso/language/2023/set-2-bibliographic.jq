...

{
  ...
  "$comment": "Set 2 bibliographic is a superset of Set 1 and covers every registered code element, including special and collective codes that are not part of Set 3. Bibliographic codes are based on English language names",
  ...
  "anyOf": ((
    ...
    | sort_by(.code)
    | map({
        "x-jsonld-self": ("http://id.loc.gov/vocabulary/iso639-2/" + .code),
        "title": .name
      } +
